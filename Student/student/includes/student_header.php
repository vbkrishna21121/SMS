                    ...
                    <ul class="navbar-nav ms-auto mb-2">
                      ...
                      <li class="nav-item dropdown dropdown_content">
                        ...
                        <ul class="dropdown-menu dropdown_item" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="change_student_pass.php">Settings</a></li>
                            <li><a class="dropdown-item" href="student.php?login='1'">Sign Out</a></li>
                        </ul>
                      </li>
                  </div>
                </div>
