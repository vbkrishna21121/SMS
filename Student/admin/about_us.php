...
$conn = mysqli_connect('localhost', 'root', '', 'student_management');
    $view = "select * from about_contact_page where PageType = 'aboutus'";
...
if(isset($_POST['update'])){
    ...
    $sql = "UPDATE `about_contact_page` SET `PageTitle`='$title',`PageDescription`='$desc' WHERE PageType = 'aboutus'";
