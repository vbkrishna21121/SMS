                        ...
                        <div class="card-body">
                            <table class="table table-bordered table-responsive">
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT * from public_notice where Deleted = '0'";
                                    if($result = mysqli_query($conn, $sql)){
                                        if(mysqli_num_rows($result)>0){
                                            while($row = mysqli_fetch_assoc($result)){
                                                ...
                                                echo"<td>"; 
                                                echo '<a href="update_public_notice.php?S_No='.$row['S_No'].'"><i class="bi bi-eye"></i></a>';
                                                echo "</td>";
                                                echo"<td>";
                                                echo '<a href="delete_public_notice.php?S_No='.$row['S_No'].'"><i class="bi bi-trash3"></i></a>';
                                                echo "</td>";
                                            }
                                        }else{
                                            echo "No Data";
